    ...
    <div className="container mx-auto p-4">
      <div className="relative mb-6">
        <Input
          ...
          className="pl-10 pr-4 py-2 border-2 border-orange-300 rounded-full focus:border-orange-500 focus:ring focus:ring-orange-200 focus:ring-opacity-50"
        />
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(9)].map((_, index) => (
            <Card key={index} className="w-full h-40 animate-pulse bg-orange-100 rounded-lg shadow-md" />
          ))}
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card key={story.objectID} className="w-full bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent className="p-4">
                <p className="text-sm text-gray-600 mb-3 flex items-center">
                  <ThumbsUp className="mr-2 text-orange-500" size={16} />
                ...
                <a
                  ...
                  className="text-orange-500 hover:text-orange-700 flex items-center font-medium"
                >
